...
const BreadcrumbList = React.forwardRef(({ className, ...props }, ref) => (_jsx("ol", { ref: ref, className: cn("flex flex-wrap items-center gap-1.5 break-words text-sm text-zinc-500 sm:gap-2.5 dark:text-zinc-400", className), ...props })));
...
const BreadcrumbLink = React.forwardRef(({ asChild, className, ...props }, ref) => {
    ...
    return (_jsx(Comp, { ref: ref, className: cn("transition-colors hover:text-zinc-950 dark:hover:text-zinc-50", className), ...props }));
});
BreadcrumbLink.displayName = "BreadcrumbLink";
const BreadcrumbPage = React.forwardRef(({ className, ...props }, ref) => (_jsx("span", { ref: ref, role: "link", "aria-disabled": "true", "aria-current": "page", className: cn("font-normal text-zinc-950 dark:text-zinc-50", className), ...props })));
